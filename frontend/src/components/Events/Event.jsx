            ...
            {event ?
                (<>
                    ...
                    <div>
                        <div className="d-flex flex-row-reverse">
                            <div className="btn-group">
                                <LinkButtonPlus to={`/expense/editor?eventId=${event.id}`} />
                            </div>
                        </div>

                        <div className="mt-3 list-group">
                            {event.expenses.map(e => (
                                <Link to={`/expense/editor?expenseId=${e.id}&eventId=${event.id}`} className="list-group-item list-group-item-action" aria-current="true">
                                    <div className="container">
                                        <div className="row">
                                            <div className="col-8 ">
                                            ...
                                            <div className="col-4 d-flex flex-column ">
                                                <small className="align-self-end">{dayjs(e.date).format("DD.MM.YYYY")}</small>
                                                <div className="d-flex flex-fill justify-content-end h-100">
                                                    <p className="h3 align-self-center" ><span>{e.credit.amount}</span> {e.currency}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
